<template>
  <Layout spec="tales" :sub="railLinks">
    ...
    <section>
      <h2>Poundcake</h2>
      <p>The plan was for all of us to go see Pulp Fiction in the theater that night. We were at ----'s house to pick her up, she had to get some yardwork done so we 4~5 of us hopped out to help her. I also had a massive crush on her and offered to come back the next day to rake leaves. Her mom had made a poundcake and offered us some for the effort, it was a logical road snack. We snuck it into the theater and had this amazing cake while watching Pulp Fiction for the first time.</p>
    </section>
  </Layout>
</template>
    ...
    meta: [
      {
        hid: 'description',
        name: 'description',
        content: 'Some stories behind the 1994 track of ARX by P1RK5',
      }
    ],
  },
  data () {
